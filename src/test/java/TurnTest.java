...
public class TurnTest extends TestCase {
    ...
    public void testBasicQuery(){
        ...
        assertFalse(GM.baseQuery("Yes/No", scanner));
        assertTrue(GM.baseQuery("Yes/No", scanner));
        assertTrue(GM.baseQuery("Yes/No", scanner));
        assertFalse(GM.baseQuery("Yes/No", scanner));
    ...
    public void testFreeTerritories(){
        ...
        assertEquals(3, k.getFreeArmiesFromTerritories(GM, placeholder));
        ...
        assertEquals(4, k.getFreeArmiesFromTerritories(GM, placeholder));
        k.player.addTerritories("CHINA");
        assertEquals(4, k.getFreeArmiesFromTerritories(GM, placeholder));
        k.player.addTerritories("VENEZUELA");
        assertEquals(6, k.getFreeArmiesFromTerritories(GM, placeholder));
    }
    ...
    public void testFreeTerritoriesWithCards(){
        ...
        assertEquals(3, k.getFreeArmiesFromTerritories(GM, placeholder));
        assertEquals(7, k.getFreeArmiesFromTerritories(GM, placeholder));
    ...
    public void testFreeTerritoriesWithCards2() {
        ...
        assertEquals(9, k.getFreeArmiesFromTerritories(GM, placeholder));
    ...
    public void testFreeTerritoriesWithCards3() {
        ...
        k.player.getHand().get("INFANTRY").push(new Card("NORTHERN EUROPE", "INFANTRY"));
        k.player.getHand().get("INFANTRY").push(new Card("MIDDLE EAST", "INFANTRY"));
        assertEquals(11, k.getFreeArmiesFromTerritories(GM, placeholder));
        // 3+10
        k.player.getHand().get("WILD").push(new Card("ALASKA", "WILD"));
        k.player.getHand().get("INFANTRY").push(new Card("NORTHERN EUROPE", "INFANTRY"));
        k.player.getHand().get("INFANTRY").push(new Card("MIDDLE EAST", "INFANTRY"));
        assertEquals(13, k.getFreeArmiesFromTerritories(GM, placeholder));

        // 3+12
        k.player.getHand().get("WILD").push(new Card("ALASKA", "WILD"));
        k.player.getHand().get("INFANTRY").push(new Card("NORTHERN EUROPE", "INFANTRY"));
        k.player.getHand().get("INFANTRY").push(new Card("MIDDLE EAST", "INFANTRY"));
        assertEquals(15, k.getFreeArmiesFromTerritories(GM, placeholder));

        // 3+15
        k.player.getHand().get("INFANTRY").push(new Card("ARGENTINA", "INFANTRY"));
        k.player.getHand().get("INFANTRY").push(new Card("NORTHERN EUROPE", "INFANTRY"));
        k.player.getHand().get("INFANTRY").push(new Card("MIDDLE EAST", "INFANTRY"));
        assertEquals(18, k.getFreeArmiesFromTerritories(GM, placeholder));
        ...
        assertEquals(23, k.getFreeArmiesFromTerritories(GM, placeholder));
        ...
        k.player.getHand().get("ARTILLERY").push(new Card("MIDDLE EAST", "ARTILLERY"));
        assertEquals(28, k.getFreeArmiesFromTerritories(GM, placeholder));
